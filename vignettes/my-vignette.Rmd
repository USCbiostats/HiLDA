...
author: 
- name: Zhi Yang
  affiliation: Department of Preventive Medicine, University of Southern California, Los Angeles, USA 
...
```{r}
inputFile <- system.file("sample/sample.rdata", package = "HiLDA")
```
...
```{r eval=FALSE}
pmBarplot(G, Param, refGroup=1:4)
```
